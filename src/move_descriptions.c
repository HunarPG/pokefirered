...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_HIDDEN_POWER_NORMAL    - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_FIRE      - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_WATER     - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_ELECTRIC  - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_GRASS     - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_ICE       - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_FIGHTING  - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_POISON    - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_GROUND    - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_FLYING    - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_PSYCHIC   - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_BUG       - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_ROCK      - 1] = gMoveDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_GHOST     - 1] = gMoveDescription_HiddenPower,
