const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_WEATHER_BALL_FIRE]      = _("WEATHER BALL"),
    [MOVE_WEATHER_BALL_WATER]     = _("WEATHER BALL"),
    [MOVE_DRILL_RUN]              = _("DRILL RUN"),
    [MOVE_HIDDEN_POWER_NORMAL]    = _("HIDDEN POWER"),
    ...
    [MOVE_HIDDEN_POWER_PSYCHIC]   = _("HIDDEN POWER"),
