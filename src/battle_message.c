...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_NUZLOCKEENCOUNTERUSED - BATTLESTRINGS_TABLE_START]         = gText_CantThrowPokeballNuzlocke,
    [STRINGID_SPECIESCLAUSE - BATTLESTRINGS_TABLE_START]                 = gText_CantThrowPokeballSpeciesClause
};
